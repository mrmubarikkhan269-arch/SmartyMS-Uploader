...
# Global retry counter (was missing — caused NameError crashes)
failed_counter = 0
...
async def default_download(url, cmd, name):
    """Core download logic — file dhundh ke return karo."""
    try:
...
async def download_video(url, cmd, name):
    ...
    aria2c se fast parallel download karta hai.
    visionias / penpencilvod ke liye retry logic hai.
    """
    global failed_counter
